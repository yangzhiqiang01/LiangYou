...
public class JCVideoPlayerStandard extends JCVideoPlayer {
    DowloadVedioListener mListener;
     ...
     * @param listener 监听者
     */
    public void setListener(DowloadVedioListener listener) {
        mListener = listener;
    }
    ...
    public void setUp(String url, int screen, Object... objects) {
        super.setUp(url, screen, objects);
            try {
                format = url.substring(url.length() - 3, url.length());
            } catch (Exception e) {
                e.printStackTrace();
            }
...
//            }
    ...
    public interface DowloadVedioListener{
        void dowload();
