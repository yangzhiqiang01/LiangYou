 ...
 * specified {@link DidNotDownloadFragment.OnListFragmentInteractionListener}.
...
public class MyItemRecyclerViewAdapter2 extends RecyclerView.Adapter<MyItemRecyclerViewAdapter2.ViewHolder> {
    ...
    private final DidNotDownloadFragment.OnListFragmentInteractionListener mListener;

    public MyItemRecyclerViewAdapter2(List<DummyContent.DummyItem> items, DidNotDownloadFragment.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
