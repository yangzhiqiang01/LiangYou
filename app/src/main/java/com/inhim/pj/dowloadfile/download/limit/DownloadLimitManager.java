...
import com.inhim.pj.dowloadfile.download.DownloadIO;
...
public class DownloadLimitManager {
    ...
    public void cancelDownload(DownloadInfo info){
        ...
        EventBus.getDefault().post(info);
        FileUtils.deleteFiles(info.getFileName());
    }
    ...
    private DownloadInfo getRealFileName(DownloadInfo downloadInfo) {
        ...
        File path = new File(Urls.getFilePath());
        if (!path.exists()) {
            path.mkdir();
        }
        File file = new File(Urls.getFilePath(), fileName);
        if (file.exists()) {
        ...
        while (downloadLength >= contentLength) {
            ...
            File newFile = new File(Urls.getFilePath(), fileNameOther);
            file = newFile;
    ...
    private class DownloadSubscribe implements ObservableOnSubscribe<DownloadInfo> {
        ...
        public void subscribe(ObservableEmitter<DownloadInfo> e) throws Exception {
            ...
            File file = new File(Urls.getFilePath(), downloadInfo.getFileName());
            InputStream is = null;
