...
import com.inhim.pj.adapter.SeriesTitleAdapter;
...
public class SeriesProvider extends BaseItemProvider<ReaderStyle, BaseViewHolder> {
    ...
    @Override
    public void convert(BaseViewHolder helper, final ReaderStyle news, int i) {
        if (news == null) {
            //如果没有，则直接跳过
            return;
        }
        try{
            ...
            SeriesTitleAdapter adapter = new SeriesTitleAdapter(news,context);
            ...
            recyclerView.addOnItemTouchListener(new RecyclerViewClickListener(context,
                ...
                public void onItemClick(View view, int position) {
                    ...
                    intent.putExtra("ReaderStyle",news.getList().get(position));
